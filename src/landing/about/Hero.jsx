        ...
        <div className="container">
            ...
            <div className="row p-5 mt-5 mb-5 border-top fs-6" style={{lineHeight:"1.8", fontSize:"1.2rem", fontWeight:"450"}}>
                ...
                <div className="col p-5 fs-6">
                    ...
                    <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us or learn more about
                        our business and product philosophies.</p>
                </div>
